# Marek’s reference model for the modern digital workplace

This GitHub repo is home to Marek's 1-3-7 reference model for the modern digital workplace.
...
I work for a systems integrator and it's my job to collect **all** the pieces of a solution that are required 
and knit them together into something **that works** for all the stakeholders.
